...
logger.log("info", "[PATH " + __dirname);
...
logger.log('info', "----MESSAGE: " + message);
                try{
                    ...
                    if (tMsg['config']) {
logger.log('info', "----MESSAGE CONFIG");
...
logger.log('info', "MESSAGE to admin: " +JSON.stringify(buildUpdateMessagesForAdmin()));
